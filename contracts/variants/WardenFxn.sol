...
/// @author Paladin
/*
    Delegation market based on veFXN VotingEscrowDelegation contract
*/
contract WardenFxn is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    IVotingEscrowBoost public delegationBoost;
    ...
    function _buyDelegationBoost(
        ...
        delegationBoost.checkpoint(delegator);
    ...
    function _canDelegate(
        ...
        uint256 delegableBalance = delegationBoost.delegableBalance(delegator);
    ...
    function setDelegationBoost(address newDelegationBoost) external onlyOwner {
        delegationBoost = IVotingEscrowBoost(newDelegationBoost);
    }
